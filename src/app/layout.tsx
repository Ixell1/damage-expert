...
const jsonLd = {
  ...
  '@graph': [
    // 1. LocalBusiness + AutomotiveBusiness (kombinovano za max recognition)
    {
      ...
      email: 'marko.jankovic@proceniteljstete.rs',
      priceRange: 'RSD',
  ...
  return (
    <html lang="sr-Latn-RS" className={`${inter.variable} ${spaceGrotesk.variable}`} suppressHydrationWarning>
      <head>
        ...
        {/*
          Google Ads / Google Tag (gtag.js) - AW-18353918983
          Ne blokira render (afterInteractive). Prati konverzije za Google Ads kampanje.
        */}
        <Script
          id="gtag-src"
          src="https://www.googletagmanager.com/gtag/js?id=AW-18353918983"
